...
<header class="w3-bar w3-padding-12 color-dark-blue w3-mobile">
    ...
    <div class="w3-dropdown-hover w3-right">
        ...
        <div id="UserDropdownMenu" class="w3-dropdown-content w3-bar-block w3-card-4">
            <a href="<?= site_url("login") ?>" class="w3-bar-item w3-button"><i class="fa fa-user-plus"></i> Uloguj se</a>
            <a href="<?= site_url("register") ?>" class="w3-bar-item w3-button"><i class="fa fa-sign-in"></i> Registruj se</a>
        </div>
    </div>
